...
<div id="page-inner">
			...
			<center>	
				<form  action="AboutUs.php" method = "post" enctype="multipart/form-data">
						...
						<?php 
						$result_1 = $con->query("Select * from static where page='AboutUs' ");
						while($row_1 = $result_1->fetch_assoc())
						{
						...
						<?php
						if($row_1['status']==1){
						echo"<iframe src=\"uploads\AboutUs\profile".$_SESSION['username'].".pdf\"  style=\"height:100%\" width=\"900px\"> </iframe>";
						}
						else{
