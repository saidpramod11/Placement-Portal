...
<div id="page-inner">
			...
			<center>	
				<form  action="Terms&Conditions.php" method = "post" enctype="multipart/form-data">
						...
						<?php
						if($row_1['status']==1){
						echo "<iframe src=\"uploads\TermsAndConditions\profile".$_SESSION['username'].".pdf\" style=\"height:100%\" width=\"900px\"> </iframe>";
						}
						else{
						echo "<iframe src=\"uploads\profiledefault2.pdf\" style=\"height:100%\" width=\"900px\"></iframe>";
						}
						?>
						...
						if(in_array($fileActualExt, $allowed)){
							if($fileError==0){
								if($fileSize<500000){ 
									...
									$fileDestination='uploads/TermsAndConditions/'.$fileNameNew;
									move_uploaded_file($fileTmpName, $fileDestination);
									$sql="UPDATE static SET status=1 WHERE static_id=2";
