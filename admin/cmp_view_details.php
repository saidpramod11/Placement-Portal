...
?>	
				...
				<?php 
						...
						$sql="SELECT * FROM `cmpedit_profile` where username='".$user."'";
						$res=$con->query($sql);
						//$res->num_rows;
						if($res->num_rows>0){
				...
				<a href="cmp_details.php"><input type = "button" value="Back" class="styled-button-8" style="margin-left:100px;"/></a>
					...
					<center><h2>
						...
						<td colspan="2">
							...
							<td>
							<input name="company" type="text" class="form-control" placeholder="Enter company Name" value="<?php echo $row_1['company']; ?>" readonly>
							</td>
						</tr>
						<td colspan="2">
							...
							<td>
							<input name="established" type="date" class="form-control" value="<?php echo $row_1['established']; ?>" readonly>
							</td>
						</tr>
						...
						<tr>
							...
							<td><input name="email"  class = "form-control" placeholder = "eg..abc@gmail.com" value="<?php $sql2="Select * from cmp_login";
						...
						<tr>
						  ...
						  <td><input name="url" class="form-control" placeholder="Enter your Website Url" value="<?php echo $row_1['url']; ?>" readonly></td>
						  </tr>
						...
						<tr>
							...
							<td>
							<input name="contact" type="text" class="form-control" maxlength="10" placeholder="+91" value="<?php $sql2="Select * from cmp_login";
										$result_4 = $con->query($sql2);
										while($row_4 = mysqli_fetch_array($result_4)){
										if($row_1['username'] == $row_4['username']){
										echo $row_4['contact'];	
						...
						<tr>
							...
							<label>City :</label>
							<td> 
							<input name="city" type="text" class="form-control" maxlength="80" value="<?php echo $row_1['city']; ?>" readonly>
							</td>
							</td>
						</tr>	
						...
						<tr>
							...
							<td>
							<input name="pincode" type="text" class="form-control" maxlength="6" placeholder="Enter Your postal/zip code" value="<?php
						...
						<tr>
							...
							<td><input name="address" type="text" class="form-control" maxlength="80" value="<?php echo $row_1['address']; ?>" readonly></td>
						</tr>
