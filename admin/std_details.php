		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="table-responsive">
					...
					<div align="right"><a href='std_details.php' data-toggle="tooltip" data-placement="top" title="Print Preview"><input type="submit" class="btn btn-danger" value="Reset All" name="search"></a> </div>
				
<table class="table-condensed" style="margin-left:100px;" border="0">
				...
				<form action="std_details.php" method="POST">
						...
						<table class="table table-hover table-condensed" >
							...
							{ 			
								...
								<td><?php echo $row_3['post_graduation']; ?></td>
								...
								<td>
									...
									<td>
										<a href='update_std.php?id=<?php echo $row_3['username']; ?>'data-toggle="tooltip" data-placement="top" title="Update Information"><span class="glyphicon glyphicon-edit" style="font-size:20px; color:black;"></span></a>
									</td>
									<td>
										<a href='delete_rec.php?id=<?php echo $row_3['username']; ?>' data-toggle="tooltip" data-placement="top" title="Delete Account"><span class="glyphicon glyphicon-trash" style="font-size:20px; color:red"></span></a>
									</td>
