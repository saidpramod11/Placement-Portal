...
?>	
				...
				?>
					<tr><td colspan ="4"><h3>Basic Details- <hr/></h3></td></tr>
						...
						<tr>
							...
							<td colspan="1"><input name="father_name" type="text" class="form-control" value="<?php echo $row['father_name']; ?>" ></td>
						</tr>	
							
						<tr>
							<td colspan="2"><label>Mother's Name:</label></td>
							<td colspan="1"><input name="mother_name" type="text" class="form-control" value="<?php echo $row['mother_name']; ?>" ></td>
						</tr>	

						<tr>
						   <td colspan="2"><label>Gender:</label>
							<td colspan="2">
								<input type="radio" name="gender" class ="radio" value="male"<?php echo $row['gender']=="male"?"checked":" " ?>>Male<br>
								<input type="radio" name="gender" class ="radio" value="female"<?php echo $row['gender']=="female"?"checked":" " ?> >Female<br>	
								<input type="radio" name="gender"  class ="radio" value="other"<?php echo $row['gender']=="other"?"checked":" " ?> >Others<br>
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="1"><input name="date_of_birth" type = "date" class = "form-control" value="<?php echo $row['date_of_birth']; ?>" /></td>
						</tr>
						...
						<tr>
						 ...
						 <tr>
							...
							<td colspan="1">
							<input name="email" type="text" class="form-control" maxlength="80" value="<?php echo $row_2['email']; ?>" /></td>
						</tr>
						...
						<tr>
							...
							<td colspan="1"><input name="X_percentage" type="text" class="form-control" maxlength="5" value="<?php echo $row['X_percentage']; ?>"/></td>
							
							<td colspan="1"><label>&nbsp;&nbsp;&nbsp;&nbsp;Year_of_passing:</label></td>
							<td colspan="1"><input name="year_of_passing1" type = "text" class = "form-control" maxlength="4" value="<?php echo $row['year_of_passing1']; ?>" /></td>
						</tr>
                        ...
                        <tr>
                           ...
                           <td colspan="1"><input name="XII_percentage" type="text" class="form-control" maxlength="5" value="<?php echo $row['XII_percentage']; ?>" /></td> 
							
							<td colspan="1"><label>&nbsp;&nbsp;&nbsp;&nbsp;Year_of_passing:</label></td>
							<td colspan="1"><input name="year_of_passing2" type="text" class = "form-control" maxlength="4" value="<?php echo $row['year_of_passing2']; ?>" /></td>
						</tr> 
						...
						<tr>
							...
							<td colspan="1"><label>&nbsp;&nbsp;&nbsp;&nbsp;Year_of_passing:</label></td>
							<td colspan="1"><input name="year_of_passing3" type = "text" class = "form-control" maxlength="4" value="<?php echo $row['year_of_passing3']; ?>" /></td>
						</tr>
						
						<tr>
							<td colspan="1"><label>University:&nbsp;</label></td>
							<td colspan="1"><input name="university" type="text" class="form-control" maxlength="80" value="<?php echo $row['university']; ?>" /></td>
						</tr>
							...
							<td colspan="1"><label>&nbsp;&nbsp;&nbsp;&nbsp;Year_of_passing:</label></td>
							<td colspan="1"><input name="year_of_passing4" type = "text" class = "form-control" maxlength="4" value="<?php echo $row['year_of_passing4']; ?>" /></td>
						...
						<tr>
							<td colspan="1"><label>University:&nbsp;</label></td>
							<td colspan="1"><input name="university2" type="text" class="form-control" maxlength="80" value="<?php echo $row['university2']; ?>" /></td>
						</tr>
						...
						<tr>
							...
							<td><input name="city" type="text" class="form-control" maxlength="40" value="<?php echo $row['city']; ?>" /></td>
						</tr>
	
						
						<tr>
							<td><label>Pincode :</label></td>
							<td><input name="pincode" type="text" class="form-control" maxlength="6" value="<?php echo $row['pincode']; ?>" /></td>
						</tr>
						
						<tr>
							<td><label>Landmark :</label></td>
							<td><input name="landmark" type="text" class="form-control" maxlength="80" value="<?php echo $row['landmark']; ?>" /></td>
						</tr>
						
						<tr>
							<td><label>Address :</label></td>
							<td><input name="address" type="text" class="form-control" maxlength="80" value="<?php echo $row['address']; ?>" /></td>
						</tr>
						<tr><td colspan="4">
	...
	if(isset($_POST['submit']))
		...
		university2='".$university2."' where username='".$username."' ";
