		...
		<section id="banner">
			...
			?>
				...
				if(isset($_POST['submit']))
				{
					...
					$query_check="select * from std_login where password='$oldpass' and username='$username' ";
					$result=mysqli_query($con,$query_check);
					$count=mysqli_num_rows($result);
					if($count > 0)
					{
							$query="update std_login set password='$newpass' where password='$oldpass' and username='$username' ";
