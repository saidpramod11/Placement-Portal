		...
		<section id="banner">
			...
			?>
				...
				<tr><td>
					...
					<a href="placement_detail.php"><input type = "button" value="Back" class="btn btn-primary"/></a>	
					<table class="table" width="45%" cellspacing="12" border="0">
								<tr><td colspan="3">
								<h1 id="hea"><center>Students Placed</center></h1>
								</td></tr>
							<?php 
							if(isset($_GET['id']))
						{
