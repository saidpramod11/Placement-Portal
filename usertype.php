...
<body style="background-image:url('images/14.jpg'); background-size:100%;">
	...
	<div id="main-wrapper2" style="height:400px">
			
			<center><h2>Select User Type</h2></center>
				<table border="0" style="margin-left:20%;"><tr><td>
				<center>
			...
			<tr><td></td></tr>
				...
				<tr><td>
				<input type="button" style="margin-top:10%;" class='btn btn-primary'  value="Student Registeration" onclick="window.location.href='stdregister.php'" />&nbsp;
				
				<input type="button" style="margin-top:10%;" class='btn btn-primary' value="Company Registeration" onclick="window.location.href='cmpregister.php'" />
				</td></tr>
				</table>
		</div>					
