...
?>	
			...
			<div id="main-wrap">
				<form  action="supdate_profile.php" method = "post" enctype="multipart/form-data">
					...
					<a href="cstd_details.php"><input type = "button" value="Back" class="styled-button-8" style="margin-left:100px;"/></a>
...
<!--Echo "<img src=http://www.yoursite.com/images/".$infoto'] ."> <br>";--> 
						...
						<tr>
							...
							<td colspan="1"><input name="contact" type="text" class="form-control" maxlength="10" value="<?php echo $row['contact']; ?>" disabled="disabled"/></td>
						</tr>
						 ...
						 <tr>
							...
							<td colspan="1">
							<input name="email" type="text" class="form-control" maxlength="80" value="<?php echo $row['email']; ?>" disabled="disabled"/></td>
						</tr>
